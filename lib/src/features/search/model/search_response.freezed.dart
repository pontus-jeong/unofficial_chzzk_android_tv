...
/// @nodoc
@JsonSerializable()
class _$SearchChannelResponseImpl extends _SearchChannelResponse {
...
abstract class _SearchChannelResponse extends SearchChannelResponse {
  const factory _SearchChannelResponse(
      {required final int size,
      required final List<dynamic> data}) = _$SearchChannelResponseImpl;
  const _SearchChannelResponse._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$SearchVodResponseImpl extends _SearchVodResponse {
...
abstract class _SearchVodResponse extends SearchVodResponse {
  const factory _SearchVodResponse(
      {required final int size,
      required final List<dynamic> data}) = _$SearchVodResponseImpl;
  const _SearchVodResponse._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$SearchLiveResponseImpl extends _SearchLiveResponse {
...
abstract class _SearchLiveResponse extends SearchLiveResponse {
  const factory _SearchLiveResponse(
      {required final int size,
      required final List<dynamic> data}) = _$SearchLiveResponseImpl;
  const _SearchLiveResponse._() : super._();
