...
/// @nodoc
@JsonSerializable()
class _$NaverClipImpl extends _NaverClip {
...
abstract class _NaverClip extends NaverClip {
...
/// @nodoc
@JsonSerializable()
class _$OwnerChannelImpl extends _OwnerChannel {
...
/// @nodoc
@JsonSerializable()
class _$RecIdImpl extends _RecId {
  const _$RecIdImpl(
      {this.seedClipUID,
      this.fromType,
      this.listType,
...
abstract class _RecId extends RecId {
...
/// @nodoc
@JsonSerializable()
class _$ContentLineageImpl extends _ContentLineage {
...
abstract class _ContentLineage extends ContentLineage {
  const factory _ContentLineage(
      {final String? contentSource,
      final String? contentType,
      final ContentTag? contentTag}) = _$ContentLineageImpl;
  const _ContentLineage._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$ContentTagImpl extends _ContentTag {
...
class _$ExternalImpl extends _External {
  const _$ExternalImpl({this.rqt, this.apiRequestKey}) : super._();
