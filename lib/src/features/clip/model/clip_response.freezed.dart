...
/// @nodoc
@JsonSerializable()
class _$PopularClipResponseImpl extends _PopularClipResponse {
...
abstract class _PopularClipResponse extends PopularClipResponse {
  const factory _PopularClipResponse(
      {required final int size,
      final PopularClipPage? page,
      required final List<NaverClip> data}) = _$PopularClipResponseImpl;
  const _PopularClipResponse._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$PopularClipPageImpl extends _PopularClipPage {
  const _$PopularClipPageImpl({this.next}) : super._();
...
abstract class _PopularClipPage extends PopularClipPage {
  const factory _PopularClipPage({final PopularClipNext? next}) =
      _$PopularClipPageImpl;
  const _PopularClipPage._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$PopularClipNextImpl extends _PopularClipNext {
  const _$PopularClipNextImpl({this.next}) : super._();
...
abstract class _PopularClipNext extends PopularClipNext {
  const factory _PopularClipNext({final String? next}) = _$PopularClipNextImpl;
  const _PopularClipNext._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$CategoryClipResponseImpl extends _CategoryClipResponse {
...
abstract class _CategoryClipResponse extends CategoryClipResponse {
  const factory _CategoryClipResponse(
      {required final int size,
      final CategoryClipPage? page,
      required final List<NaverClip> data}) = _$CategoryClipResponseImpl;
  const _CategoryClipResponse._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$CategoryClipPageImpl extends _CategoryClipPage {
  const _$CategoryClipPageImpl({this.next}) : super._();
...
abstract class _CategoryClipPage extends CategoryClipPage {
  const factory _CategoryClipPage({final CategoryClipNext? next}) =
      _$CategoryClipPageImpl;
  const _CategoryClipPage._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$CategoryClipNextImpl extends _CategoryClipNext {
  const _$CategoryClipNextImpl({this.clipUID, this.readCount}) : super._();
...
/// @nodoc
@JsonSerializable()
class _$ChannelClipResponseImpl extends _ChannelClipResponse {
...
abstract class _ChannelClipResponse extends ChannelClipResponse {
  const factory _ChannelClipResponse(
      {required final int size,
      final ChannelClipPage? page,
      required final List<NaverClip> data,
      final bool? hasStreamerClips}) = _$ChannelClipResponseImpl;
  const _ChannelClipResponse._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$ChannelClipPageImpl extends _ChannelClipPage {
  const _$ChannelClipPageImpl({this.next}) : super._();
...
abstract class _ChannelClipPage extends ChannelClipPage {
  const factory _ChannelClipPage({final ChannelClipNext? next}) =
      _$ChannelClipPageImpl;
  const _ChannelClipPage._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$ChannelClipNextImpl extends _ChannelClipNext {
  const _$ChannelClipNextImpl({this.clipUID, this.readCount}) : super._();
