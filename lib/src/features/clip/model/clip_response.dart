...
class PopularClipPage with _$PopularClipPage {
  const PopularClipPage._();

  const factory PopularClipPage({
    PopularClipNext? next,
  }) = _PopularClipPage;
...
class PopularClipNext with _$PopularClipNext {
  const PopularClipNext._();

  const factory PopularClipNext({
    String? next,
  }) = _PopularClipNext;
...
class CategoryClipPage with _$CategoryClipPage {
  const CategoryClipPage._();

  const factory CategoryClipPage({
    CategoryClipNext? next,
  }) = _CategoryClipPage;
...
class ChannelClipPage with _$ChannelClipPage {
  const ChannelClipPage._();

  const factory ChannelClipPage({
    ChannelClipNext? next,
  }) = _ChannelClipPage;
