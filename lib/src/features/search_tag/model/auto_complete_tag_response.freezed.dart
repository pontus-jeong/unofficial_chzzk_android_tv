...
/// @nodoc
@JsonSerializable()
class _$AutoCompleteTagResponseImpl extends _AutoCompleteTagResponse {
...
abstract class _AutoCompleteTagResponse extends AutoCompleteTagResponse {
  const factory _AutoCompleteTagResponse(
      {required final List<String> keywords}) = _$AutoCompleteTagResponseImpl;
  const _AutoCompleteTagResponse._() : super._();
