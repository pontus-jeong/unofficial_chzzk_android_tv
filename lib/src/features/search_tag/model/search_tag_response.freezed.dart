...
/// @nodoc
@JsonSerializable()
class _$SearchTagLiveResponseImpl extends _SearchTagLiveResponse {
...
abstract class _SearchTagLiveResponse extends SearchTagLiveResponse {
  const factory _SearchTagLiveResponse(
      {required final int size,
      final SearchTagLivePage? page,
      required final List<LiveInfo> data}) = _$SearchTagLiveResponseImpl;
  const _SearchTagLiveResponse._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$SearchTagLivePageImpl extends _SearchTagLivePage {
  const _$SearchTagLivePageImpl({this.next}) : super._();
...
abstract class _SearchTagLivePage extends SearchTagLivePage {
  const factory _SearchTagLivePage({final SearchTagLiveNext? next}) =
      _$SearchTagLivePageImpl;
  const _SearchTagLivePage._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$SearchTagLiveNextImpl extends _SearchTagLiveNext {
...
/// @nodoc
@JsonSerializable()
class _$SearchTagVodResponseImpl extends _SearchTagVodResponse {
...
abstract class _SearchTagVodResponse extends SearchTagVodResponse {
  const factory _SearchTagVodResponse(
      {required final int size,
      final SearchTagVodPage? page,
      required final List<Vod> data}) = _$SearchTagVodResponseImpl;
  const _SearchTagVodResponse._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$SearchTagVodPageImpl extends _SearchTagVodPage {
  const _$SearchTagVodPageImpl({this.next}) : super._();
...
abstract class _SearchTagVodPage extends SearchTagVodPage {
  const factory _SearchTagVodPage({final SearchTagVodNext? next}) =
      _$SearchTagVodPageImpl;
  const _SearchTagVodPage._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$SearchTagVodNextImpl extends _SearchTagVodNext {
  const _$SearchTagVodNextImpl({required this.start}) : super._();
...
abstract class _SearchTagVodNext extends SearchTagVodNext {
  const factory _SearchTagVodNext({required final int start}) =
      _$SearchTagVodNextImpl;
  const _SearchTagVodNext._() : super._();
