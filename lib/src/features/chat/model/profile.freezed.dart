...
mixin _$Profile {
  ...
  String? get userRoleCode => throw _privateConstructorUsedError;
...
/// @nodoc
@JsonSerializable()
class _$ChzzkBadgeImpl extends _ChzzkBadge {
  const _$ChzzkBadgeImpl({this.imageUrl}) : super._();
...
abstract class _ChzzkBadge extends ChzzkBadge {
  const factory _ChzzkBadge({final String? imageUrl}) = _$ChzzkBadgeImpl;
  const _ChzzkBadge._() : super._();
