...
/// @nodoc
@JsonSerializable()
class _$BaseChatImpl extends _BaseChat {
  const _$BaseChatImpl(
      {required this.msg, this.profile, this.extras, required this.ctime})
      : super._();
