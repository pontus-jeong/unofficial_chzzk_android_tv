...
/// @nodoc
@JsonSerializable()
class _$FollowingImpl extends _Following {
...
abstract class _Following extends Following {
...
/// @nodoc
@JsonSerializable()
class _$StreamerImpl extends _Streamer {
  const _$StreamerImpl({required this.openLive}) : super._();
