...
/// @nodoc
@JsonSerializable()
class _$WatchingHistoryResponseImpl extends _WatchingHistoryResponse {
...
abstract class _WatchingHistoryResponse extends WatchingHistoryResponse {
  const factory _WatchingHistoryResponse(
          {required final int size,
          final WatchingHistoryPage? page,
          required final List<WatchingHistory> data}) =
      _$WatchingHistoryResponseImpl;
  const _WatchingHistoryResponse._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$WatchingHistoryPageImpl extends _WatchingHistoryPage {
  const _$WatchingHistoryPageImpl({this.next}) : super._();
...
abstract class _WatchingHistoryPage extends WatchingHistoryPage {
  const factory _WatchingHistoryPage({final WatchingHistoryNext? next}) =
      _$WatchingHistoryPageImpl;
  const _WatchingHistoryPage._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$WatchingHistoryNextImpl extends _WatchingHistoryNext {
  const _$WatchingHistoryNextImpl({this.lastTime}) : super._();
...
abstract class _WatchingHistoryNext extends WatchingHistoryNext {
  const factory _WatchingHistoryNext({final int? lastTime}) =
      _$WatchingHistoryNextImpl;
  const _WatchingHistoryNext._() : super._();
