...
/// @nodoc
@JsonSerializable()
class _$CategoryPageImpl extends _CategoryPage {
  const _$CategoryPageImpl({this.next}) : super._();
...
abstract class _CategoryPage extends CategoryPage {
  const factory _CategoryPage({final CategoryNext? next}) = _$CategoryPageImpl;
  const _CategoryPage._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$CategoryNextImpl extends _CategoryNext {
...
abstract class _CategoryNext extends CategoryNext {
...
/// @nodoc
@JsonSerializable()
class _$FollowingCategoryResponseImpl extends _FollowingCategoryResponse {
...
abstract class _FollowingCategoryResponse extends FollowingCategoryResponse {
  const factory _FollowingCategoryResponse(
      {final List<Category>? followingList}) = _$FollowingCategoryResponseImpl;
  const _FollowingCategoryResponse._() : super._();
