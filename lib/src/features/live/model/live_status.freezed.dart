...
mixin _$LiveStatus {
  ...
  bool get abroadCountry => throw _privateConstructorUsedError;
  ...
  int get chatSlowModeSec => throw _privateConstructorUsedError;
  bool get chatEmojiMode => throw _privateConstructorUsedError;
...
/// @nodoc
@JsonSerializable()
class _$LiveStatusImpl extends _LiveStatus {
...
abstract class _LiveStatus extends LiveStatus {
  const factory _LiveStatus(
      ...
      final Object? faultStatus,
      final String? userAdultStatus,
      required final bool abroadCountry,
      final String? blindType,
      ...
      required final int chatSlowModeSec,
      required final bool chatEmojiMode,
      required final bool chatDonationRankingExposure,
      final int? watchPartyNo,
      final String? watchPartyTag,
      required final bool timeMachineActive,
      required final String channelId}) = _$LiveStatusImpl;
  const _LiveStatus._() : super._();
