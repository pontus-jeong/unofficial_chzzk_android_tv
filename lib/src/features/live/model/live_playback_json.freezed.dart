...
/// @nodoc
@JsonSerializable()
class _$LivePlaybackJsonImpl extends _LivePlaybackJson {
...
abstract class _LivePlaybackJson extends LivePlaybackJson {
  const factory _LivePlaybackJson(
      ...
      required final List<Map<String, String>> api,
      required final List<Media> media,
      required final Thumbnail thumbnail}) = _$LivePlaybackJsonImpl;
  const _LivePlaybackJson._() : super._();
...
mixin _$Meta {
  ...
  String? get playbackAuthType => throw _privateConstructorUsedError;
...
abstract class _Meta extends Meta {
  const factory _Meta(
      ...
      final bool? p2p,
      final bool? cmcdEnabled,
      final String? playbackAuthType}) = _$MetaImpl;
...
/// @nodoc
@JsonSerializable()
class _$CdnInfoImpl extends _CdnInfo {
  const _$CdnInfoImpl({required this.cdnType, this.zeroRating}) : super._();
...
abstract class _CdnInfo extends CdnInfo {
  const factory _CdnInfo(
      {required final String cdnType, final bool? zeroRating}) = _$CdnInfoImpl;
  const _CdnInfo._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$ServiceMetaImpl extends _ServiceMeta {
  const _$ServiceMetaImpl({required this.contentType}) : super._();
...
abstract class _ServiceMeta extends ServiceMeta {
  const factory _ServiceMeta({required final String contentType}) =
      _$ServiceMetaImpl;
  const _ServiceMeta._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$LiveImpl extends _Live {
  const _$LiveImpl(
      {required this.start,
      required this.open,
...
mixin _$EncodingTrack {
  ...
  String? get videoDynamicRange => throw _privateConstructorUsedError;
...
/// @nodoc
@JsonSerializable()
class _$EncodingTrackImpl extends _EncodingTrack {
...
abstract class _EncodingTrack extends EncodingTrack {
  const factory _EncodingTrack(
      ...
      final String? path,
      final String? audioCodec,
      final bool? audioOnly}) = _$EncodingTrackImpl;
  const _EncodingTrack._() : super._();
