...
/// @nodoc
@JsonSerializable()
class _$LiveResponseImpl extends _LiveResponse {
...
/// @nodoc
@JsonSerializable()
class _$LivePageImpl extends _LivePage {
  const _$LivePageImpl({this.next}) : super._();
...
abstract class _LivePage extends LivePage {
  const factory _LivePage({final LiveNext? next}) = _$LivePageImpl;
  const _LivePage._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$LiveNextImpl extends _LiveNext {
