...
mixin _$VodEvent {
  ...
  /// Serializes this VodEvent to a JSON map.
...
/// @nodoc
@JsonSerializable()
class _$VodEventImpl extends _VodEvent {
...
abstract class _VodEvent extends VodEvent {
...
mixin _$Payload {
  ...
  int? get awt => throw _privateConstructorUsedError;
...
/// @nodoc
@JsonSerializable()
class _$PayloadImpl extends _Payload {
  const _$PayloadImpl(
...
abstract class _Payload extends Payload {
  const factory _Payload(
      ...
      required final int positionAt,
      final int? awt}) = _$PayloadImpl;
